...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className={`bg-black/80 backdrop-blur-md p-3 rounded-xl shadow-2xl font-mono text-xs z-50 transition-all duration-200 border ${isFailed ? "border-rose-500/50 shadow-[0_0_20px_rgba(244,63,94,0.2)]" : "border-white/10"
        }`}>
